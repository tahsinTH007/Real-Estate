  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent-500 text-ink shadow-sm hover:bg-accent-400 hover:shadow-md",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-sand-300 bg-white text-ink hover:border-sand-400 hover:bg-sand-50",
        secondary: "bg-sand-100 text-ink hover:bg-sand-200",
        ghost: "text-ink-muted hover:bg-sand-100 hover:text-ink",
        link: "text-brand-700 underline-offset-4 hover:underline",
        inverse: "bg-white text-ink shadow-sm hover:bg-sand-50",
      },
      size: {
